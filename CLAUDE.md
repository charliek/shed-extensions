...
- `cmd/shed-host-agent/` — Host-side daemon (macOS): subscribes to shed-server plugin bus, handles credential operations
...
- Namespaces: `ssh-agent` (Phase 1), `aws-credentials` (Phase 2)
